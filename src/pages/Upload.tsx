...
export default function Upload() {
  ...
  const startServer = async () => {
    ...
    addLog(
      "info",
      "Iniciando servidor Flask (start_server.py)...",
      <Server className="w-4 h-4" />
    );

    try {
      // Chamada real para iniciar o servidor
      ...
      if (response.ok) {
        ...
        addLog(
          "success",
          "Servidor start_server.py iniciado com sucesso!",
      ...
      toast({
        title: "Erro",
        description: "Falha ao iniciar servidor",
        variant: "destructive",
      });
    }
  };
